...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full bg-gray-700 flex flex-wrap justify-between items-center px-6 py-3 shadow-md z-20">
            ...
            <div
                className={clicked ?
                    "fixed bottom-0 left-0 lg:w-[300px] lg:h-[80%] sm:hidden w-[-1px] h-[-1px] bg-gray-500 z-10 p-4 shadow-lg overflow-y-auto duration-400"
                    : "fixed bottom-[-100%] left-[-100%] lg:w-[300px] lg:h-full sm:hidden w-[-1px] h-[-1px] bg-gray-500 z-10 duration-400"
                }
            >
                <nav>
